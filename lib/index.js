...
import { applyConfigSync } from './config-jobs.js';
import { createExternalApiHandler } from './external-api.js';
...
export function apply(ctx, config) {
  ...
  // runs before the scheduler starts so declared jobs are armed with the rest;
