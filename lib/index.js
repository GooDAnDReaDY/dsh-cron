...
export function apply(ctx, config) {
  ...
  ctx.tools.register(defineTool({
    ...
    description: 'Создать новую запланированную задачу cron (запуск по расписанию)',
    parameters: {
      type: 'object',
      properties: {
        title: { type: 'string', description: 'Краткое название задачи' },
        schedule: { type: 'string', description: 'Расписание: cron-выражение (например, "0 9 * * *") или интервал ("every 2h", "каждый день в 15:00")' },
