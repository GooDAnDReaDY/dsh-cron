...
- Текущий статус: active. Релиз `0.2.4` (рантаймы исполнения и доставка с
  секретами) подготовлен из `main` (PR #114, независимое ревью — PASS на
  `7216b3a`) после полного прогона 112/112 и приёмки на MiniPC; публикуется
  одобренным циклом владельца (проверено 2026-09-11).
